// CaffeFn.cpp : 
// CaffeSrc/WordEmbed/GramPosValid
...
{
    string H5TrainFileName="/devlink/caffe/data/WordEmbed/GramPosValid/data/train.h5";
    string H5TestFileName="/devlink/caffe/data/WordEmbed/GramPosValid/data/test.h5";
	string WordListFileName="/devlink/caffe/data/WordEmbed/GramPosValid/data/WordList.txt";
