...
void protobuf_AssignDesc_GenData_2eproto() {
  ...
  static const int CaffeGenData_offsets_[13] = {
...
bool CaffeGenData::IsInitialized() const {
  if ((_has_bits_[0] & 0x00001fc7) != 0x00001fc7) return false;
