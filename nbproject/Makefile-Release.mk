...
${OBJECTDIR}/CaffeFn.o: CaffeFn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CaffeFn.o CaffeFn.cpp

${OBJECTDIR}/CheckersIntf.o: CheckersIntf.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckersIntf.o CheckersIntf.cpp

${OBJECTDIR}/CheckersText.o: CheckersText.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CheckersText.o CheckersText.cpp

${OBJECTDIR}/DepGrps.o: DepGrps.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DepGrps.o DepGrps.cpp

${OBJECTDIR}/ForLearn.o: ForLearn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ForLearn.o ForLearn.cpp
...
${OBJECTDIR}/GrpsCntrl.o: GrpsCntrl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrpsCntrl.o GrpsCntrl.cpp

${OBJECTDIR}/GrpsCreate.o: GrpsCreate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrpsCreate.o GrpsCreate.cpp

${OBJECTDIR}/GrpsFile.o: GrpsFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrpsFile.o GrpsFile.cpp

${OBJECTDIR}/MascFiles.o: MascFiles.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MascFiles.o MascFiles.cpp

${OBJECTDIR}/MascReader.o: MascReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MascReader.o MascReader.cpp

${OBJECTDIR}/NodeConfig.o: NodeConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodeConfig.o NodeConfig.cpp

${OBJECTDIR}/RF/discrete_dist.o: RF/discrete_dist.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/discrete_dist.o RF/discrete_dist.cc

${OBJECTDIR}/RF/instance_set.o: RF/instance_set.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/instance_set.o RF/instance_set.cc

${OBJECTDIR}/RF/random_forest.o: RF/random_forest.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/random_forest.o RF/random_forest.cc

${OBJECTDIR}/RF/test.o: RF/test.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/test.o RF/test.cc

${OBJECTDIR}/RF/tree.o: RF/tree.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/tree.o RF/tree.cc

${OBJECTDIR}/RF/tree_node.o: RF/tree_node.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/tree_node.o RF/tree_node.cc

${OBJECTDIR}/RF/weights.o: RF/weights.cc 
	${MKDIR} -p ${OBJECTDIR}/RF
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RF/weights.o RF/weights.cc

${OBJECTDIR}/Regex2D.o: Regex2D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Regex2D.o Regex2D.cpp

${OBJECTDIR}/RegexLearn.o: RegexLearn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegexLearn.o RegexLearn.cpp

${OBJECTDIR}/StanfordReader.o: StanfordReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StanfordReader.o StanfordReader.cpp

${OBJECTDIR}/TaskFns.o: TaskFns.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TaskFns.o TaskFns.cpp

${OBJECTDIR}/TaskLists.o: TaskLists.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TaskLists.o TaskLists.cpp

${OBJECTDIR}/WordAligned.o: WordAligned.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WordAligned.o WordAligned.cpp

${OBJECTDIR}/WordCorrect.o: WordCorrect.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WordCorrect.o WordCorrect.cpp

${OBJECTDIR}/WordGroup.o: WordGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WordGroup.o WordGroup.cpp

${OBJECTDIR}/WordSwap.o: WordSwap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WordSwap.o WordSwap.cpp

${OBJECTDIR}/XmlParser.o: XmlParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XmlParser.o XmlParser.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IRF -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
